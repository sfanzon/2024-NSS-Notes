...
![Representation of integers $\Z$](/images/integers.png){#fig-integers width=40%}
...
![Fractions $\frac{1}{n}$ can get arbitrarily close to $0$](/images/integers_ratio.png){width=40%}
...
![Representing $\sqrt{2}$ on the numbers line.](/images/integers_root_2.png){width=40%}
