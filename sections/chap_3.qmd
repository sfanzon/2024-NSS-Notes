...
::: Example
### An example of binary operation  {#example-binary-operation}
...
- $(\Q, + , \cdot)$ **is a field**. This is clear: The field axioms are introduced exactly to model $\Q$. Therefore, $\Q$ is trivially a field.
...
![Schematic picture of a partition $(A,B)$ of the set $K$.](/images/partition.png){width=35%}
...
![$(A,B)$ is a cut of $\Q$ with separator $s$.](/images/cut.png){width=40%}
...
![$(A,B)$ is a cut of $\Q$ which has no separator](/images/cut_sqrt2.png){width=40%}
...
![Supremum and upper bounds of a set $A$ in the field $K$](/images/definition_supremum.png){width=40%}
...
![Infimum and lower bounds of a set $A$ in the field $K$](/images/definition_infimum.png){width=40%}
...
![Supremum, upper bounds, infimum and lower bounds of a set $A$ in $K$](/images/definition_sup_inf.png){#fig-inf-sup width=40%}
...
In particular, Theorem \ref{theorem-Q-not-complete} can be re-stated as follows.
...
![Let $s$ be the separator of the cut $(B^c,B)$, with $B$ the set of upper bounds of $A$. Then $s = \sup A$.](/images/construction_cut_1.png){#fig-cut-complete-1 width=40%}


![Let $(A,B)$ be a cut of $K$ and let $s = \sup A$. Then $s$ is the separator of the cut $(A,B)$.](/images/construction_cut_2.png){#fig-cut-complete-2 width=40%}
