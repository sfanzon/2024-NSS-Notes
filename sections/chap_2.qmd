...
Consider the set of rational numbers $\Q$. The equality defines a **binary relation** on $\Q \times \Q$, via
$$
R:=\{ (x,y) \in \Q \times \Q \, \colon \, x=y  \} \,.
$$
Let us check that $R$ is an **equivalence relation**:

1. Reflexive: It holds, since $x=x$ for all $x \in \Q$,

2. Symmetric: Again $x = y$ if and only if $y = x$,

3. Transitive: If $x = y$ and $y = z$ then $x = z$.

The class of equivalence of $x \in \Q$ is given by
$$
[x] = \{ x \}\,,
$$
...
We have shown that $R$ is an equivalence relation on $\Q$.
